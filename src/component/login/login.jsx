        ...
        <span className="language-tooltip">
                            ...
                            <Form className="text-start">
                                ...
                                <div className="mb-3 position-relative">
                                    <label className="form-label fw-semibold">
                                        <FaUserAlt className="input-icon" />{t.username}</label>
                                    <Field
                                        type="text"
                                        name="username"
                                ...
                                <div className="mb-3 position-relative">
                                    <label className="form-label fw-semibold">
                                        <FaLock className="input-icon" />{t.password}</label>
            ...
            <footer className="footer text-center">
                <div className="container">
                    <p className="mb-0">
                        {t.developed} <strong>Vedant Tech Solutions</strong> © {new Date().getFullYear()} HRMS
                    </p>
